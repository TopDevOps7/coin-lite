<div id="privacy-policy" class="px-2 py-5">
    <div class="container">
        <h1>Privacy Policy</h1>
        <p>
            At <?php echo esc_html( $GLOBALS['site']['name'] ); ?>, accessible from ’<?php echo esc_html( site_url() ); ?>’, one of our main priorities is the privacy of our visitors.
            This Privacy Policy document contains types of information that is collected and recorded by <?php echo esc_html( $GLOBALS['site']['name'] ); ?> and how we use it.
        </p>
        <p>
            If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.
        </p>
        <p>
            This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in <?php echo esc_html( $GLOBALS['site']['name'] ); ?>.
            This policy is not applicable to any information collected offline or via channels other than this website.
        </p>

        <h3 class="mt-5">Consent</h3>
        <p>
        ...
        <h3 class="mt-5">How We Use Your Information</h3>
        <div>
        ...
        <h3 class="mt-5">Log Files</h3>
        <p>
            <?php echo esc_html( $GLOBALS['site']['name'] ); ?> follows a standard procedure of using log files.
        ...
        <p>
            Like any other website, <?php echo esc_html( $GLOBALS['site']['name'] ); ?> uses ’cookies’.
        ...
        <p>
            Read our
            <a href="<?php echo esc_url( site_url( PAGE_COOKIES_POLICY ) ); ?>">Cookies Policy</a>
            for better understanding about cookie usage.
        </p>

        <h3 class="mt-5">Third Party Privacy Policies</h3>
        <p>
            <?php echo esc_html( $GLOBALS['site']['name'] ); ?>’s Privacy Policy does not apply to other advertisers or websites.
            ...
            These technologies on websites that you visit.
        </p>
        <p>
        ...
        <h3 class="mt-5">CCPA Privacy Rights (Do Not Sell My Personal Information)</h3>
        <div>
        ...
        <h3 class="mt-5">GDPR Privacy Policy (Data Protection Rights)</h3>
        <div>
        ...
        <p>
            <?php echo esc_html( $GLOBALS['site']['name'] ); ?> does not knowingly collect any Personal Identifiable Information from children under the age of 13.
